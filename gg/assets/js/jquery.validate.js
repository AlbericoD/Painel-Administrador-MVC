...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Você deve ter errado algo.",
		...
		digits: "Apenas digitos aqui.",
		creditcard: "Por favor, entre com um numero de cartão válido.",
		equalTo: "Por favor entre com o mesmo valor.",
		maxlength: $.validator.format( "Não insira mais do que {0} letras." ),
		minlength: $.validator.format( "Digite pelo menos  {0} letras." ),
		rangelength: $.validator.format( "Insira um valor entre {0} e {1} letras grandes!?." ),
